...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_DEFAULT_SYMBOL_INDEX_TYPE("cairo.default.symbol.index.type"),
    ...
    CAIRO_POSTING_SEAL_GEN_THRESHOLD("cairo.posting.seal.gen.threshold"),
    ...
    CAIRO_SQL_SAMPLEBY_FILL_SORT_STRATEGY("cairo.sql.sampleby.fill.sort.strategy"),
    ...
    CAIRO_LIVE_VIEW_CHECKPOINT_COMPACTION_INTERVAL("cairo.live.view.checkpoint.compaction.interval"),
    CAIRO_LIVE_VIEW_CHECKPOINT_MAX_DURATION_MICROS("cairo.live.view.checkpoint.max.duration.micros"),
    CAIRO_LIVE_VIEW_CHECKPOINT_PURGE_INTERVAL("cairo.live.view.checkpoint.purge.interval"),
    ...
    QWP_UDP_MAX_UNCOMMITTED_DATAGRAMS("qwp.udp.max.uncommitted.datagrams"),
    ...
    QWP_UDP_UNICAST("qwp.udp.unicast"),
    ...
    LIVE_VIEW_REFRESH_WORKER_COUNT("live.view.refresh.worker.count"),
    LIVE_VIEW_REFRESH_WORKER_AFFINITY("live.view.refresh.worker.affinity"),
    LIVE_VIEW_REFRESH_WORKER_HALT_ON_ERROR("live.view.refresh.worker.haltOnError"),
    LIVE_VIEW_REFRESH_WORKER_NAP_THRESHOLD("live.view.refresh.worker.nap.threshold"),
    LIVE_VIEW_REFRESH_WORKER_SLEEP_THRESHOLD("live.view.refresh.worker.sleep.threshold"),
    LIVE_VIEW_REFRESH_WORKER_SLEEP_TIMEOUT("live.view.refresh.worker.sleep.timeout"),
